...
@author: siavashriazi
# this is based on 230725_mhChain.py with some modif to run on cluster
"""
...
# Changing the current working directory to current directory 
os.chdir('./')

# make a directory 
#os.mkdir('./testdir')
# Open the CSV file in write mode
filename = 'chain'+chainNum+'.csv'
